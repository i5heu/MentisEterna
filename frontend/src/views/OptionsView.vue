    ...
    <div class="options-wrap">
        <div class="options-card">
            ...
            <section class="options-section">
                ...
                <p class="section-desc">
                    Pair this browser with your other devices. The other device
                    confirms each pairing — after that both devices are
                    connected both ways. Send text or files by clicking the app
                    title. Payloads are encrypted end to end — the server only
                    relays opaque ciphertext.
                </p>
...
onMounted(async () => {
    ...
    try {
        ...
        // Device identity unavailable (no WebCrypto); pairing stays disabled.
    }
});
</script>
