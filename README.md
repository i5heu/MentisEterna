...
- [x] On S3: files that are not in our file list but present in the bucket should be deleted with a button in settings: "Delete Unknown Files"
...
- [ ] User uploads (including inline uploads) in chunks, verify checksum and resume if connection is lost.
...
- [x] Add a tag search mode too the search-input.
- [x] Tag Index Note Type differentiate between auto tags and user tags.
